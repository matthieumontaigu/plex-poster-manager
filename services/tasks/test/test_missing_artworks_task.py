...
class TestMissingArtworksTask(unittest.TestCase):
    ...
    def test_update_missing_artworks(self, _mock_sleep):
        ...
        # Movie 6: empty_artworks → keep in cache
        artworks_updater.update.side_effect = [
            ...
            ("empty_artworks", None),  # for Movie 6
        ]
        ...
        # ArtworksUpdater.update should be called for 1,3,4,5,6 (but not 2)
        ...
        self.assertEqual(update_calls_movies, [1, 3, 4, 5, 6])
        ...
        # Movie 6 empty (empty_artworks branch)
        self.assertNotIn("artworks", cached_movies[6])
